<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="active">
                    <a href="index.html"><img src="{{asset('assets/Backend/img/icons/dashboard.svg')}}" alt="img" /><span>
                            Dashboard</span>
                    </a>
                </li>
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/product.svg')}}" alt="img" /><span>
                            CMS</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                            <a href="{{route("admin:header:list")}}">Header Section</a>
                        </li>
                    </ul>
                </li>
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/sales1.svg')}}" alt="img" /><span>
                            Sales</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/purchase1.svg')}}" alt="img" /><span>
                            Purchase</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/expense1.svg')}}" alt="img" /><span>
                            Expense</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/quotation1.svg')}}" alt="img" /><span>
                            Quotation</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/transfer1.svg')}}" alt="img" /><span>
                            Transfer</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/return1.svg')}}" alt="img" /><span>
                            Return</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/users1.svg')}}" alt="img" /><span>
                            People</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/places.svg')}}" alt="img" /><span>
                            Places</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/time.svg')}}" alt="img" /><span>
                            Report</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{asset('assets/Backend/img/icons/settings.svg')}}" alt="img" /><span>
                            Settings</span>
                        <span class="menu-arrow"></span></a>
                    <ul>
                        <li>
