    ...
    <ul class="nav user-menu">
        <li class="nav-item">
            <div class="top-nav-search">
                ...
                <form action="#">
                    ...
                    <a class="btn" id="searchdiv"><img src="{{asset('assets/Backend/img/icons/search.svg')}}" alt="img" /></a>
                </form>
            </div>
        </li>
        ...
        <li class="nav-item dropdown has-arrow flag-nav">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                <img src="{{asset('assets/Backend/img/flags/us1.png')}}" alt="" height="20" />
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('assets/Backend/img/flags/us.png')}}" alt="" height="16" />
                    English
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('assets/Backend/img/flags/fr.png')}}" alt="" height="16" />
                    French
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('assets/Backend/img/flags/es.png')}}" alt="" height="16" />
                    Spanish
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{asset('assets/Backend/img/flags/de.png')}}" alt="" height="16" />
                    German
                </a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <img src="{{asset('assets/Backend/img/icons/notification-bing.svg')}}" alt="img" />
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-img"><img src="{{asset('assets/Backend/img/profiles/avator1.jpg')}}" alt="" />
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0" />
                    <a class="dropdown-item logout pb-0" href="signin.html"><img src="{{asset('assets/Backend/img/icons/log-out.svg')}}"
