                        ...
                        <div class="graph-sets">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-white btn-sm dropdown-toggle" type="button" id="dropdownMenuButton"
                                    ...
                                    2022
                                    <img src="{{ asset('assets/Backend/img/icons/dropdown.svg') }}" alt="img"
                                        class="ms-2" />
                                </button>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{ asset('assets/Backend/img/product/product22.jpg') }}"
                                                    alt="product" />
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{ asset('assets/Backend/img/product/product23.jpg') }}"
                                                    alt="product" />
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{ asset('assets/Backend/img/product/product24.jpg') }}"
                                                    alt="product" />
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{ asset('assets/Backend/img/product/product6.jpg') }}"
                                                    alt="product" />
                                            </a>
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="productlist.html">
                                        <img src="{{ asset('assets/Backend/img/product/product2.jpg') }}"
                                            alt="product" />
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="productlist.html">
                                        <img src="{{ asset('assets/Backend/img/product/product3.jpg') }}"
                                            alt="product" />
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="productlist.html">
                                        <img src="{{ asset('assets/Backend/img/product/product4.jpg') }}"
                                            alt="product" />
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="productlist.html">
                                        <img src="{{ asset('assets/Backend/img/product/product5.jpg') }}"
                                            alt="product" />
                                    </a>
